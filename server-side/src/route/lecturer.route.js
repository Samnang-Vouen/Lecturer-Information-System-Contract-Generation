...
import { getAllUsers, createUser, updateUser, toggleUserStatus, deleteUser, createLecturerFromCandidate } from '../controller/user.controller.js';
import { getLecturers, getLecturerDetail, updateLecturerCourses, updateLecturerProfile, uploadLecturerPayroll } from '../controller/lecturer.controller.js';
