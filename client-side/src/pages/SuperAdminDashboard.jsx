  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      try {
        setIsLoading(true);
        setError(null);
        // Fetch superadmin system-wide summary and recent activities
        const [summaryRes, statsRes] = await Promise.all([
          axiosInstance.get('/dashboard/superadmin/summary'),
          axiosInstance.get('/dashboard/stats')
        ]);
        const summary = summaryRes?.data || {};
        const data = statsRes?.data || {};

        // Normalize and format for UI
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4 sm:gap-6 mb-8">
            ...
            <div className="bg-white p-5 sm:p-6 rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300">
              ...
              <div>
                ...
                <span className="text-2xl sm:text-3xl font-bold text-gray-900">{dashboardData.activeLecturers.count}</span>
            ...
            <div className="bg-white p-5 sm:p-6 rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300">
              ...
              <div>
                ...
                <span className="text-2xl sm:text-3xl font-bold text-gray-900">{dashboardData.activeContracts.count}</span>
            ...
            <div className="bg-white p-5 sm:p-6 rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300">
              ...
              <div>
                ...
                <span className="text-2xl sm:text-3xl font-bold text-gray-900">{dashboardData.recruitmentInProgress.count}</span>
            ...
            <div className="bg-white p-5 sm:p-6 rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300">
              ...
              <div>
                ...
                <span className="text-2xl sm:text-3xl font-bold text-gray-900">{dashboardData.totalUsers.count}</span>
