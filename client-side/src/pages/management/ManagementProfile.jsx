          ...
          <div className="bg-gradient-to-r from-indigo-600 via-blue-600 to-blue-600 px-4 sm:px-8 py-8 sm:py-12">
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6">
              ...
              <div className="text-white min-w-0 w-full">
                <h1 className="text-2xl sm:text-4xl font-bold mb-1 sm:mb-2 truncate">{profile?.fullName || "Administrator"}</h1>
                <p className="text-white/90 text-sm sm:text-lg truncate">{profile?.email}</p>
                <div className="flex flex-wrap items-center gap-2 sm:gap-3 mt-3">
                  <span className="inline-flex items-center px-3 py-1 rounded-full bg-white/20 backdrop-blur-sm text-xs sm:text-sm font-medium">
                  ...
                  {profile?.department && (
                    <span className="inline-flex items-center px-3 py-1 rounded-full bg-white/20 backdrop-blur-sm text-xs sm:text-sm font-medium">
                      ...
                      <span className="truncate max-w-[60vw] sm:max-w-none">{profile.department}</span>
                    </span>
                  )}
                </div>
              </div>
                ...
                {profile?.department && (
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-slate-900 font-semibold break-words">{profile.department}</p>
                    </div>
                  </div>
                )}
              </div>
