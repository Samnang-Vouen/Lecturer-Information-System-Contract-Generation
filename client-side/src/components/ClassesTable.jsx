...
export default function ClassesTable({ classes, onEdit, onDelete, onAssignCourses, loading, courseCatalog = [], title, description, selectable = false, selectedIds = [], onToggleOne, onToggleAll }) {
  const codeToName = React.useMemo(()=> {
    const map = new Map();
            ...
            {selectable && (
              <TableHead className="w-10">
                <Checkbox
                  ...
                  onCheckedChange={(val)=> onToggleAll && onToggleAll(!!val)}
                />
              </TableHead>
            )}
              ...
              {selectable && (
                <TableCell className="w-10">
                  <Checkbox
                    ...
                    onCheckedChange={()=> onToggleOne && onToggleOne(classItem.id)}
                  />
                </TableCell>
              )}
