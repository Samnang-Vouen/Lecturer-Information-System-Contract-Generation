...
// Mock components to simulate your existing UI components
...
const Input = ({ className, ...props }) => (
  <input className={`rounded-lg transition-all duration-300 ${className}`} {...props} />
);
    ...
    return (
        <div className="min-h-screen flex relative overflow-hidden bg-gradient-to-br from-blue-600 via-blue-700 to-blue-800">
            ...
            <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-blue-500/30 via-blue-600/20 to-blue-800/30 animate-gradient-x"></div>
