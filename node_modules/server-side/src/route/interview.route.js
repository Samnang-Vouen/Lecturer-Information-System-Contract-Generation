...
import { getInterviewQuestions, addInterviewQuestion, updateInterviewQuestion, searchInterviewQuestions, addCandidateQuestion, getCandidateInterviewDetails } from '../controller/interview.controller.js';
...
router.get('/candidates/:id/interview-details', protect, authorizeRoles(['admin']), getCandidateInterviewDetails);
